export default function Process() {
  return <section className="process-section" id="process" aria-labelledby="process-title"><div className="container">
    <div className="process-heading"><div className="section-tag">RÕ RÀNG TỪ BƯỚC ĐẦU TIÊN</div><h2 className="section-title" id="process-title">Quy trình làm việc<br /><em>với luật sư.</em></h2></div>
    <div className="process-grid">{[
      ['01', 'Tiếp nhận hồ sơ', 'Chia sẻ câu chuyện, nhu cầu và hồ sơ của bạn trong một cuộc trao đổi bảo mật.'],
